...
sys.path.append('/home/pi/SDL_Pi_BeaconAir/config')
...
def buildGraphString():
    ...
    response = ""
    valuecount = ""
    f = open("/home/pi/SDL_Pi_BeaconAir/state/iBeaconCountGraph.txt", "w")
...
def iBeacondetect(RSSIArray):
	...
	buildGraphString()
	f = open("/home/pi/SDL_Pi_BeaconAir/state/beaconCount.txt", "w") 
	f.write(str(count))
	f.close() 
